  ...
  link: (scope, element, attrs) ->
    scope.opt =
      "TagRule::FilterShippingMethods":
         textTop: "phương thức giao hàng được gắn thẻ"
         textBottom: "là:"
      ...
      "TagRule::FilterPaymentMethods":
         textTop: "Phương thức thanh toán được gắn thẻ"
         textBottom: "là:"
      ...
      "TagRule::FilterOrderCycles":
         textTop: "Chu kỳ đặt hàng được gắn thẻ"
         textBottom: "là:"
         taggable: "exchange"
      ...
      "TagRule::FilterProducts":
         textTop: "Các biến thể trong kho được gắn thẻ"
         textBottom: "là:"
         taggable: "variant"
